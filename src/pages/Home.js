...
const HomePage = props => {
    return <PageContainer>
        ...
        <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap" }}>
            <img style={{ flexBasis: "auto", flexGrow: 1, maxWidth: "40rem" }} src="../../images/gains.png" alt="Gains" />
            <div style={{ flexBasis: "20rem", flexGrow: 2, padding: "1rem" }}>
                <h4 style={{ fontWeight: 600, textAlign: "center", marginTop: "5rem" }}>What We Do</h4>
